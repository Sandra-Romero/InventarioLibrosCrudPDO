            ...
            ?>
                ...
                <?php
                    foreach ($conn->query($sql) as $row) {
                        ...
                        echo "<td>";
                        echo "<a class=\"btn btn-warning\" href=\"http://localhost/inventarioPDO/editar_editorial.php?codigoEditorial=". $row["codigoEditorial"]."\"><i class=\"fas fa-edit\"></i></a> ";
                        echo "<a class=\"btn btn-danger\" href=\"http://localhost/inventarioPDO/eliminar_editorial.php?codigo=". $row["codigoEditorial"]."\"><i class=\"far fa-trash-alt\"></i></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
