            ...
            $sql = "SELECT * FROM autores";
                ...
                <?php
                   foreach ($conn->query($sql) as $row) {
                        ...
                        echo "<td>";
                        echo "<a class=\"btn btn-warning\" href=\"http://localhost/inventarioPDO/editar_autor.php?codigoAutor=". $row["codigoAutor"]."\"><i class=\"fas fa-edit\"></i></a> ";
                        echo "<a class=\"btn btn-danger\" href=\"http://localhost/inventarioPDO/eliminar_autor.php?codigo=". $row["codigoAutor"]."\"><i class=\"far fa-trash-alt\"></i></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
